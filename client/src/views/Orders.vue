  ...
  <div class="orders">
    ...
    <div v-else>
      ...
      <div class="card">
        ...
        <div v-if="restockingOrdersLoading" class="loading">{{ t('common.loading') }}</div>
        <div v-else-if="restockingOrdersError" class="error">{{ restockingOrdersError }}</div>
...
export default {
  ...
  setup() {
    ...
    const restockingOrdersLoading = ref(true)
    ...
    const loadRestockingOrders = async () => {
      try {
        restockingOrdersLoading.value = true
        restockingOrdersError.value = null
        restockingOrders.value = await api.getRestockingOrders()
      } catch (err) {
        restockingOrdersError.value = 'Failed to load restocking orders: ' + err.message
      } finally {
        restockingOrdersLoading.value = false
      }
    }
